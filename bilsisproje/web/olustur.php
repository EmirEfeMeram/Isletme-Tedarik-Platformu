<?php
    ...
    $miktar=$_POST["miktar"];
    $tarih=$_POST["sontarih"];
    $sehir=$_POST["sehir"];
    $not=$_POST["not"];
    $numbool=$_POST["numune"];
    $sql = "INSERT INTO ilan(al_ID,urun_ad,urun_miktar,istenilen_tarih,sehir,notlar,numune) values('$aliciid','$urunadi','$miktar','$tarih','$sehir','$not','$numbool')";
...
<div id="wrapper">
     <!-- Navigation -->
        ...
        <div id="page-wrapper">
        <div class="graphs">
            <h2 class="form-heading">İlanınız Başarıyla oluşturuldu. İlanınıza yapılıcak teklifler için Tekliflere Bak sekmesine gidebilirsiniz. </h2>

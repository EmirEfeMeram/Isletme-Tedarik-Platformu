<?php
    ...
    $ilansayisorgu= mysqli_query($conn,"SELECT alici.al_ID,alici.isletme_ad,COUNT( ilan.ilan_ID) as 'ilan_sayi'FROM alici,ilan WHERE alici.al_ID=ilan.al_ID AND ilan.al_ID='$kullaniciid'  ");
    $ilansayidizi=mysqli_fetch_array($ilansayisorgu);
    $ilansayi=$ilansayidizi['ilan_sayi'];
    $tekkabulsayisorgu=mysqli_query($conn,"SELECT teklif_kabul.al_ID,COUNT(teklif_kabul.tekkabul_ID) AS 'kabul_sayi' ,teklif_kabul.kabul FROM teklif_kabul WHERE teklif_kabul.kabul=1 AND teklif_kabul.al_ID='$kullaniciid'  ");
        ...
        <div class="col_3">
        	<div class="col-md-3 widget">
        		<div class="r3_counter_box">
                    ...
                    <div class="stats">
                      <h5><strong><?php echo $ilansayi ?></strong></h5>

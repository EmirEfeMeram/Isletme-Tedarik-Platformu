...
<div id="wrapper">
     <!-- Navigation -->
        ...
        <div id="page-wrapper">
            <form class="" action="stokekleme.php" method="post"   >
               
                <div id="urunsecimi">
                    <h4>Mevcut Ürünü Seçin</h4>
                ...
                <div id="degerler">
                    <h4>Mevcut Miktarı Girin</h4> 
                    <td>Mevcut Miktar Miktar(KG)</td>
                    <input type="number" name="miktar" id="miktar" min="1" >
                </div>
              <?php 
                echo '<td class="tg-fuxe"><button name="submit" type="submit" value="'.$kullaniciid.'">Stok Ekle</button></td>'; 
              ?> 

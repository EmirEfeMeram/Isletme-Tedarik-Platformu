<?php
    ...
    $tekfiyat=$_POST['fiyat'];
    $tekid=$_POST['submit'];
    $eklesorgu="INSERT INTO teklif(ur_ID,ilan_ID,fiyat) values('$kullaniciid','$tekid','$tekfiyat')";
    echo $tekid;
    if (mysqli_query($conn, $eklesorgu)) {
        header("Location: urteklifver.php");
    }      
    else {
        echo "Error: " . $eklesorgu . "<br>" . mysqli_error($conn);
    }
?> 
<!--
Author: W3layouts
